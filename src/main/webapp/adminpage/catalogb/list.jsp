...
<HEAD>
	...
	<script type="text/javascript">
		function addCatalogb(){
			window.location = "${pageContext.request.contextPath}/adminpage/catalogb/add.jsp";				
		}
	</script>
</HEAD>
<body>
	...
	<table rules="all" style="width: 99%; WORD-BREAK: break-all; border: gray 1px solid; BORDER-COLLAPSE: collapse; BACKGROUND-COLOR: #f5fafe; WORD-WRAP: break-word">
		...
		<tr style="background-color: white;">
			...
			<td align="center" colspan="2" style="border-right: hidden;">
				<button type="button" onclick="addCatalogb()">添加二级分类</button>
			</td>
		</tr>
		<tr style="font-weight: bold; font-size: 12pt; height: 25px; background-color: #afd1f3">
			<td width="18%" align="center">二级分类编号</td>
			<td width="18%" align="center">二级分类名称</td>
			<td width="7%" align="center">编辑</td>
			<td width="7%" align="center">删除</td>
		</tr>
		<c:forEach var="all" items="${ allCatalogb }">
			<tr onmouseover="this.style.backgroundColor = 'white'" onmouseout="this.style.backgroundColor = '#F5FAFE';">
				...
				<td align="center" style="height: 22px">
					<a href="${pageContext.request.contextPath}/editCatalogbPage?cbid=${ all.cbid }">
						<img src="${pageContext.request.contextPath}/img/i_edit.gif" style="cursor: hand">
					</a>
				</td>
				<td align="center" style="HEIGHT: 22px">
					<a href="${pageContext.request.contextPath}/deleteCatalogb?cbid=${ all.cbid }">
